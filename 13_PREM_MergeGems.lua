--[[
    KERANGKA MENU TAB -> WindUI (VERSI FINAL)w
...
-- [DESTROY SCRIPT "Animate"] Script bawaan Roblox (LocalScript "Animate" di
-- dalam Character) yang menangani animasi default: climb, fall, idle, jump,
-- run, sit, toolnone, walk (tiap kategori berisi Animation object seperti
-- ClimbAnim/FallAnim/RunAnim/dst) + RemoteEvent "PlayEmote". Script ini
-- JALAN SENDIRI secara independen dari Animator listener/polling di atas --
-- dia yang memanggil Humanoid:LoadAnimation() sendiri, jadi walaupun semua
-- AnimationTrack sudah di-Stop(), script Animate akan terus reload/replay
-- animasi idle/walk/run selama dia masih hidup. Solusi: destroy total
-- objek "Animate" di Player DAN setiap Hero (workspace.Heros), plus terus
-- disapu untuk char/hero yang baru spawn/respawn.
local function _destroyAnimateIn(root)
    if not root then return end
    local anim = root:FindFirstChild("Animate")
    if anim then
        pcall(function() anim:Destroy() end)
    end
end

local function _sweepDestroyAnimate()
    pcall(function()
        -- Player
        _destroyAnimateIn(LP.Character)
        -- Heros (struktur: workspace.Heros.Hero_XXXXXXX.<NamaHero>.Animate)
        local herosFolder = workspace:FindFirstChild("Heros")
        if herosFolder then
            for _, wrapper in ipairs(herosFolder:GetChildren()) do
                _destroyAnimateIn(wrapper)
                for _, hModel in ipairs(wrapper:GetChildren()) do
                    if hModel:IsA("Model") then
                        _destroyAnimateIn(hModel)
                    end
                end
            end
        end
...
-- Sweep awal
task.spawn(_sweepDestroyAnimate)

-- Listener reaktif: destroy "Animate" baru begitu muncul (char/hero baru)
table.insert(_animBlockConns, LP.CharacterAdded:Connect(function(char)
    task.defer(function() _destroyAnimateIn(char) end)
end))
task.spawn(function()
    local herosFolder = workspace:FindFirstChild("Heros")
    if not herosFolder then
    ...
    table.insert(_animBlockConns, herosFolder.DescendantAdded:Connect(function(desc)
...
-- Polling: sapu ulang tiap 0.5s (jaga-jaga kalau ada yang lolos listener,
-- interval lebih longgar dari sweep Animator karena Animate cuma perlu
-- didestroy sekali per char/hero, bukan tiap frame)
task.spawn(function()
    while true do
        _sweepDestroyAnimate()
        task.wait(0.5)
    end
end)
...
do
    ...
    local GEM_MERGE_MAX_LEVEL = 40  -- level ini & di atasnya di-exclude (Lv.39 = max yg bisa merge)
    local GEM_MERGE_MIN_LEVEL = 20  -- level di bawah ini di-exclude

    -- Tabel referensi iconId -> nama gem, di-generate otomatis dari data
    -- config resmi ReplicatedStorage.Scripts.Configs.Gems (hasil dump DEX
    -- Explorer). Key = IconImage.Image (asset id icon dari GemsPanel),
    -- Value = nama gem sesuai field "Name" di config.
    --
    -- CATATAN: beberapa icon (Flame Gem, thunderstone, Lunar Gem, Water Gem,
    -- Light burst Gem, Tornado Gem, dan Deadly Gem-LV18/19) dipakai bareng
    -- utk beberapa level berbeda di config resminya (icon belum di-update
    -- per level oleh dev game) -- utk kasus ini dipakai NAMA FAMILY-nya saja
    -- (tanpa suffix "-LVx"), sementara level yg ditampilkan di label dropdown
    -- tetap akurat karena diambil langsung dari NumText ("Lv.X") in-game,
    -- bukan dari config ini.
    local GEM_ICON_NAME_MAP = {
        ["rbxassetid://16562816837"] = "Ruby-LV1",
        ["rbxassetid://16562816703"] = "Ruby-LV2",
        ["rbxassetid://16562816549"] = "Ruby-LV3",
        ["rbxassetid://16562816359"] = "Ruby-LV4",
        ["rbxassetid://16562816189"] = "Ruby-LV5",
        ["rbxassetid://16562816088"] = "Ruby-LV6",
        ["rbxassetid://16562815994"] = "Ruby-LV7",
        ["rbxassetid://16562815890"] = "Ruby-LV8",
        ["rbxassetid://16562815761"] = "Ruby-LV9",
        ["rbxassetid://16562815635"] = "Ruby-LV10",
        ["rbxassetid://16562854208"] = "Emerald-LV1",
        ["rbxassetid://16562854128"] = "Emerald-LV2",
        ["rbxassetid://16562854016"] = "Emerald-LV3",
        ["rbxassetid://16562853947"] = "Emerald-LV4",
        ["rbxassetid://16562853842"] = "Emerald-LV5",
        ["rbxassetid://16562853753"] = "Emerald-LV6",
        ["rbxassetid://16562853625"] = "Emerald-LV7",
        ["rbxassetid://16562853525"] = "Emerald-LV8",
        ["rbxassetid://16562853421"] = "Emerald-LV9",
        ["rbxassetid://16562853272"] = "Emerald-LV10",
        ["rbxassetid://16562839815"] = "Sapphire-LV1",
        ["rbxassetid://16562839545"] = "Sapphire-LV2",
        ["rbxassetid://16562839371"] = "Sapphire-LV3",
        ["rbxassetid://16562839246"] = "Sapphire-LV4",
        ["rbxassetid://16562839095"] = "Sapphire-LV5",
        ["rbxassetid://16562838976"] = "Sapphire-LV6",
        ["rbxassetid://16562838863"] = "Sapphire-LV7",
        ["rbxassetid://16562838781"] = "Sapphire-LV8",
        ["rbxassetid://16562838677"] = "Sapphire-LV9",
        ["rbxassetid://16562838495"] = "Sapphire-LV10",
        ["rbxassetid://16562860976"] = "Deadly Gem-LV1",
        ["rbxassetid://16562860863"] = "Deadly Gem-LV2",
        ["rbxassetid://16562860673"] = "Deadly Gem-LV3",
        ["rbxassetid://16562860545"] = "Deadly Gem-LV4",
        ["rbxassetid://16562860412"] = "Deadly Gem-LV5",
        ["rbxassetid://16562860268"] = "Deadly Gem-LV6",
        ["rbxassetid://16562860097"] = "Deadly Gem-LV7",
        ["rbxassetid://16562860012"] = "Deadly Gem-LV8",
        ["rbxassetid://16562859935"] = "Deadly Gem-LV9",
        ["rbxassetid://16562859847"] = "Deadly Gem-LV10",
        ["rbxassetid://18228673846"] = "Colorful Gem-LV1",
        ["rbxassetid://18228685069"] = "Colorful Gem-LV2",
        ["rbxassetid://18228671564"] = "Colorful Gem-LV3",
        ["rbxassetid://18228671400"] = "Colorful Gem-LV4",
        ["rbxassetid://18228664346"] = "Colorful Gem-LV5",
        ["rbxassetid://18228664039"] = "Colorful Gem-LV6",
        ["rbxassetid://18228663856"] = "Colorful Gem-LV7",
        ["rbxassetid://18228663698"] = "Colorful Gem-LV8",
        ["rbxassetid://18228663540"] = "Colorful Gem-LV9",
        ["rbxassetid://18228663349"] = "Colorful Gem-LV10",
        ["rbxassetid://18228709910"] = "Rainbow Gem-LV1",
        ["rbxassetid://18228765961"] = "Rainbow Gem-LV2",
        ["rbxassetid://18228709661"] = "Rainbow Gem-LV3",
        ["rbxassetid://18228702735"] = "Rainbow Gem-LV4",
        ["rbxassetid://18228702361"] = "Rainbow Gem-LV5",
        ["rbxassetid://18228701930"] = "Rainbow Gem-LV6",
        ["rbxassetid://18228701579"] = "Rainbow Gem-LV7",
        ["rbxassetid://18228701245"] = "Rainbow Gem-LV8",
        ["rbxassetid://18228701016"] = "Rainbow Gem-LV9",
        ["rbxassetid://18228694917"] = "Rainbow Gem-LV10",
        ["rbxassetid://18228578678"] = "Ruby-LV11",
        ["rbxassetid://18228578497"] = "Ruby-LV12",
        ["rbxassetid://18228578317"] = "Ruby-LV13",
        ["rbxassetid://18228578063"] = "Ruby-LV14",
        ["rbxassetid://18228570433"] = "Ruby-LV15",
        ["rbxassetid://18228570204"] = "Ruby-LV16",
        ["rbxassetid://18228570026"] = "Ruby-LV17",
        ["rbxassetid://18228569888"] = "Ruby-LV18",
        ["rbxassetid://18228569663"] = "Ruby-LV19",
        ["rbxassetid://18228569459"] = "Ruby-LV20",
        ["rbxassetid://18228617389"] = "Emerald-LV11",
        ["rbxassetid://18228617140"] = "Emerald-LV12",
        ["rbxassetid://18228616925"] = "Emerald-LV13",
        ["rbxassetid://18228616638"] = "Emerald-LV14",
        ["rbxassetid://18228608534"] = "Emerald-LV15",
        ["rbxassetid://18228608298"] = "Emerald-LV16",
        ["rbxassetid://18228608069"] = "Emerald-LV17",
        ["rbxassetid://18228607816"] = "Emerald-LV18",
        ["rbxassetid://18228607590"] = "Emerald-LV19",
        ["rbxassetid://18228607344"] = "Emerald-LV20",
        ["rbxassetid://18228633826"] = "Sapphire-LV11",
        ["rbxassetid://18228633604"] = "Sapphire-LV12",
        ["rbxassetid://18228633477"] = "Sapphire-LV13",
        ["rbxassetid://18228633348"] = "Sapphire-LV14",
        ["rbxassetid://18228626929"] = "Sapphire-LV15",
        ["rbxassetid://18228626745"] = "Sapphire-LV16",
        ["rbxassetid://18228626541"] = "Sapphire-LV17",
        ["rbxassetid://18228626284"] = "Sapphire-LV18",
        ["rbxassetid://18228626039"] = "Sapphire-LV19",
        ["rbxassetid://18228625820"] = "Sapphire-LV20",
        ["rbxassetid://18228647774"] = "Deadly Gem-LV11",
        ["rbxassetid://18228647637"] = "Deadly Gem-LV12",
        ["rbxassetid://18228641162"] = "Deadly Gem-LV13",
        ["rbxassetid://18228641031"] = "Deadly Gem-LV14",
        ["rbxassetid://18228640905"] = "Deadly Gem-LV15",
        ["rbxassetid://18228640756"] = "Deadly Gem-LV16",
        ["rbxassetid://18228640584"] = "Deadly Gem-LV17",
        ["rbxassetid://18228639077"] = "Deadly Gem",
        ["rbxassetid://18228638877"] = "Deadly Gem-LV20",
        ["rbxassetid://18228656160"] = "Colorful Gem-LV11",
        ["rbxassetid://18228655841"] = "Colorful Gem-LV12",
        ["rbxassetid://18228655564"] = "Colorful Gem-LV13",
        ["rbxassetid://18228655295"] = "Colorful Gem-LV14",
        ["rbxassetid://18228655044"] = "Colorful Gem-LV15",
        ["rbxassetid://18228654843"] = "Colorful Gem-LV16",
        ["rbxassetid://18228654652"] = "Colorful Gem-LV17",
        ["rbxassetid://18228654494"] = "Colorful Gem-LV18",
        ["rbxassetid://18228654332"] = "Colorful Gem-LV19",
        ["rbxassetid://18228654148"] = "Colorful Gem-LV20",
        ["rbxassetid://18228694601"] = "Rainbow Gem-LV11",
        ["rbxassetid://18228694325"] = "Rainbow Gem-LV12",
        ["rbxassetid://18228694075"] = "Rainbow Gem-LV13",
        ["rbxassetid://18228693779"] = "Rainbow Gem-LV14",
        ["rbxassetid://18228693501"] = "Rainbow Gem-LV15",
        ["rbxassetid://18228691312"] = "Rainbow Gem-LV16",
        ["rbxassetid://18228691076"] = "Rainbow Gem-LV17",
        ["rbxassetid://18228690846"] = "Rainbow Gem-LV18",
        ["rbxassetid://18228690514"] = "Rainbow Gem-LV19",
        ["rbxassetid://18228690315"] = "Rainbow Gem-LV20",
        ["rbxassetid://18513020250"] = "Flame Gem",
        ["rbxassetid://18513019906"] = "thunderstone",
        ["rbxassetid://18513019007"] = "Lunar Gem",
        ["rbxassetid://18513019390"] = "Water Gem",
        ["rbxassetid://18944816644"] = "Purple Gem-LV1",
        ["rbxassetid://18944816414"] = "Purple Gem-LV2",
        ["rbxassetid://18944816172"] = "Purple Gem-LV3",
        ["rbxassetid://18944815837"] = "Purple Gem-LV4",
        ["rbxassetid://18944815576"] = "Purple Gem-LV5",
        ["rbxassetid://18944815014"] = "Purple Gem-LV6",
        ["rbxassetid://18944845754"] = "Purple Gem-LV7",
        ["rbxassetid://18944814159"] = "Purple Gem-LV8",
        ["rbxassetid://18944813950"] = "Purple Gem-LV9",
        ["rbxassetid://18944813734"] = "Purple Gem-LV10",
        ["rbxassetid://18944813367"] = "Purple Gem-LV11",
        ["rbxassetid://18944813099"] = "Purple Gem-LV12",
        ["rbxassetid://18944812834"] = "Purple Gem-LV13",
        ["rbxassetid://18944812545"] = "Purple Gem-LV14",
        ["rbxassetid://18944812201"] = "Purple Gem-LV15",
        ["rbxassetid://18944811973"] = "Purple Gem-LV16",
        ["rbxassetid://18944811783"] = "Purple Gem-LV17",
        ["rbxassetid://18944811495"] = "Purple Gem-LV18",
        ["rbxassetid://18944811193"] = "Purple Gem-LV19",
        ["rbxassetid://18944810974"] = "Purple Gem-LV20",
        ["rbxassetid://122054669442168"] = "Light burst Gem",
        ["rbxassetid://72721108315033"] = "Tornado Gem",
        ["rbxassetid://91258284054415"] = "Ruby-LV21",
        ["rbxassetid://137785675151321"] = "Ruby-LV22",
        ["rbxassetid://77127618062359"] = "Ruby-LV23",
        ["rbxassetid://97356229974364"] = "Ruby-LV24",
        ["rbxassetid://127541921492577"] = "Ruby-LV25",
        ["rbxassetid://116875126839244"] = "Ruby-LV26",
        ["rbxassetid://129730904619909"] = "Ruby-LV27",
        ["rbxassetid://108045229357616"] = "Ruby-LV28",
        ["rbxassetid://111679734132423"] = "Ruby-LV29",
        ["rbxassetid://135195287274356"] = "Ruby-LV30",
        ["rbxassetid://74270069527398"] = "Emerald-LV21",
        ["rbxassetid://115634463212783"] = "Emerald-LV22",
        ["rbxassetid://102600459746248"] = "Emerald-LV23",
        ["rbxassetid://88942106722210"] = "Emerald-LV24",
        ["rbxassetid://121415364976328"] = "Emerald-LV25",
        ["rbxassetid://126950163540609"] = "Emerald-LV26",
        ["rbxassetid://101160587688581"] = "Emerald-LV27",
        ["rbxassetid://125470073983629"] = "Emerald-LV28",
        ["rbxassetid://89148559488916"] = "Emerald-LV29",
        ["rbxassetid://135934266593646"] = "Emerald-LV30",
        ["rbxassetid://75952593572470"] = "Sapphire-LV21",
        ["rbxassetid://131160014464475"] = "Sapphire-LV22",
        ["rbxassetid://71538228822838"] = "Sapphire-LV23",
        ["rbxassetid://101215863859106"] = "Sapphire-LV24",
        ["rbxassetid://82504584888717"] = "Sapphire-LV25",
        ["rbxassetid://137140184242579"] = "Sapphire-LV26",
        ["rbxassetid://126753008761628"] = "Sapphire-LV27",
        ["rbxassetid://99944406692209"] = "Sapphire-LV28",
        ["rbxassetid://120786278511706"] = "Sapphire-LV29",
        ["rbxassetid://99353308747263"] = "Sapphire-LV30",
        -- Lv.31 (game update - bisa merge)
        ["rbxassetid://106887795020650"] = "Sapphire-LV31",
        ["rbxassetid://84473400549738"]  = "Emerald-LV31",
        ["rbxassetid://113213266690029"] = "Ruby-LV31",
        -- Lv.32-40 (data resmi dari DEX dump ReplicatedStorage.Scripts.Configs.Gems)
        ["rbxassetid://72821450924793"]  = "Ruby-LV32",
        ["rbxassetid://83309207714462"]  = "Ruby-LV33",
        ["rbxassetid://96257385093917"]  = "Ruby-LV34",
        ["rbxassetid://120355672718967"] = "Ruby-LV35",
        ["rbxassetid://111008233331270"] = "Ruby-LV36",
        ["rbxassetid://129103563534481"] = "Ruby-LV37",
        ["rbxassetid://109814663554030"] = "Ruby-LV38",
        ["rbxassetid://103654192884985"] = "Ruby-LV39",
        ["rbxassetid://107761419382959"] = "Ruby-LV40",
        ["rbxassetid://92292153966143"]  = "Emerald-LV32",
        ["rbxassetid://101217214794132"] = "Emerald-LV33",
        ["rbxassetid://92295361235022"]  = "Emerald-LV34",
        ["rbxassetid://103791921225384"] = "Emerald-LV35",
        ["rbxassetid://78944355977678"]  = "Emerald-LV36",
        ["rbxassetid://98274538786166"]  = "Emerald-LV37",
        ["rbxassetid://112743413042269"] = "Emerald-LV38",
        ["rbxassetid://138014658824368"] = "Emerald-LV39",
        ["rbxassetid://92323571158605"]  = "Emerald-LV40",
        ["rbxassetid://125786035312528"] = "Sapphire-LV32",
        ["rbxassetid://132033363098174"] = "Sapphire-LV33",
        ["rbxassetid://130397051137316"] = "Sapphire-LV34",
        ["rbxassetid://137232970035208"] = "Sapphire-LV35",
        ["rbxassetid://118115961033743"] = "Sapphire-LV36",
        ["rbxassetid://95066128989981"]  = "Sapphire-LV37",
        ["rbxassetid://126765990060504"] = "Sapphire-LV38",
        ["rbxassetid://94921508391599"]  = "Sapphire-LV39",
        ["rbxassetid://79756136982931"]  = "Sapphire-LV40",
    }
    ...
    local _mgSelectedName  = nil   -- nama gem grup yang dipilih (Ruby/Emerald/Sapphire)
    local _mgCount         = 1
    ...
    local function ScanGemsPanelRawMG()
        ...
        pcall(function()
            ...
            -- CATATAN PENTING (ditemukan via debug sniff):
            -- GemsPanel.ScrollingFrame kadang berisi BEBERAPA instance UI
            -- BERBEDA dengan Name (GUID) yang SAMA persis (bukan reference
            -- yang sama -- instance != instance, tapi Name identik). Ini
            -- terlihat seperti leftover/ghost UI element yang belum
            -- di-destroy game saat panel re-render. Jika tidak di-dedupe,
            -- satu gem asli bisa "digandakan" sampai 5x dalam hasil scan,
            -- menyebabkan count group jadi salah besar (mis. 1 gem asli
            -- terbaca 5 pcs). Karena guid dipakai lgsg utk GemMerge remote,
            -- WAJIB dedupe by guid SEBELUM dikirim/dipakai kemanapun.
            local seenGuid = {}
            ...
            for _, child in ipairs(sf:GetChildren()) do
                repeat
                    ...
                    if seenGuid[guidStr] then break end   -- skip instance duplikat (nama GUID sama)
    ...
    -- Whitelist: prefix nama gem yang boleh masuk dropdown merge
    local GEM_WHITELIST = { "Ruby", "Emerald", "Sapphire" }
    local function isWhitelistedGem(name)
        for _, prefix in ipairs(GEM_WHITELIST) do
            if name:sub(1, #prefix) == prefix then return true end
        end
        return false
    end

    --  ScanAndGroupMG: scan panel, kelompokkan by iconId, hanya Ruby/Emerald/Sapphire
    --  range Lv.20-31, simpan hasil ke _mgGroups (dgn label deskriptif utk dropdown).
    local function ScanAndGroupMG()
        ...
        for _, item in ipairs(raw) do
            local knownName = GEM_ICON_NAME_MAP[item.iconId]
            -- Hanya lolos jika: (1) ada di map, (2) Ruby/Emerald/Sapphire, (3) level dalam range
            if knownName and isWhitelistedGem(knownName)
                and item.level >= GEM_MERGE_MIN_LEVEL and item.level < GEM_MERGE_MAX_LEVEL then
                if not groupsByIcon[item.iconId] then
                    groupsByIcon[item.iconId] = {
                        iconId = item.iconId,
                        level  = item.level,
                        count  = 0,
                        name   = knownName,
        ...
        for i, iconId in ipairs(order) do
            ...
            if g.count >= 2 then
                table.insert(_mgGroups, {
                    ...
                    count  = g.count,
                    name   = g.name,
                    label  = g.name .. " Lv." .. g.level .. "  (" .. g.count .. " pcs)",
                })
            end
        end
    ...
    local function RefreshGroupDropdownMG()
        -- Tunggu GUI GemsPanel selesai update setelah merge/perubahan inventory
        SetMergeGemStatus("Scanning... mohon tunggu")
        task.wait(0.8)
        ...
        elseif #values == 0 then
            SetMergeGemStatus("[!] Tidak ada Ruby/Emerald/Sapphire Lv" .. GEM_MERGE_MIN_LEVEL .. "-" .. (GEM_MERGE_MAX_LEVEL - 1) .. " yg bisa di-merge (cek level/jenis/jumlah min 2pcs)")
        else
        ...
        Callback = function(on)
            if on then
                ...
                _mgThread = task.spawn(function()
                    ...
                    local gname = _mgSelectedName or "Gem"
                    while _mgRunning do
                        local cnt   = _mgCount
                        local guids = GetGemGuidsByIconMG(icon)

                        if #guids < cnt then
                            SetMergeGemStatus("[STOP] " .. gname .. " Lv" .. level .. " habis (sisa " .. #guids .. ")")
                            break
                        end
                        ...
                        SetMergeGemStatus("[M] Merging " .. gname .. " Lv" .. level .. " x" .. cnt)
                        pcall(function()
...
do
    ...
    -- [RA EXCLUDE] Musuh yang sedang dipilih di dropdown "Pilih Enemy" (section
    -- SELECT ENEMY / TARGET ATTACK di bawah) -- disimpan di sini (forward-declare,
    -- di-update oleh Callback dropdown Mode Select / Pilih Enemy / tombol REFRESH
    -- ENEMIES) supaya PickRandomEnemy milik RANDOM ATTACK (StartRA, didefinisikan
    -- lebih dulu dalam file) tetap bisa membacanya sebagai upvalue. Tujuannya:
    -- musuh yang dipilih di dropdown itu "jatah" TARGET ATTACK, RANDOM ATTACK
    -- harus selalu menghindarinya walau TARGET ATTACK belum di-ON-kan.
    local TASelected = { mode = "name", guid = nil, name = nil }

    -- [RA LOCK] Musuh hasil clone dari section FAST ATTACK 1 ENEMYS (GET/START,
    -- didefinisikan lebih jauh di bawah) -- forward-declare di sini supaya
    -- PickRandomEnemy milik RANDOM ATTACK bisa lihat. Selama .active true,
    -- RANDOM ATTACK WAJIB kunci ke .guid ini saja (bukan random musuh lain),
    -- balik normal saat FAST ATTACK 1 ENEMYS di-STOP / clone-nya hilang total.
    local FastAttack1 = { active = false, guid = nil }
    ...
    -- [EDIT] Hero TIDAK lagi ikut teleport -- hanya Player saja yang pindah posisi.
    ...
    -- [EDIT] RE.Atk (PlayerClickAttackSkill) DIHAPUS. RE.Click (ClickEnemy)
    -- dikembalikan untuk fire tiap loop seperti semula (bukan sekali saja).
    ...
    local function StartRA()
        ...
        local function PickRandomEnemy(excludeGuids)
            -- [RA LOCK] FAST ATTACK 1 ENEMYS aktif (GET sudah dipakai, clone
            -- ada) -> RANDOM ATTACK WAJIB kunci ke musuh clone itu saja,
            -- mengabaikan pool random & exclude TA dropdown selama masih aktif.
            if FastAttack1.active and FastAttack1.guid then
                for _,e in ipairs(GetEnemiesF()) do
                    if e.guid == FastAttack1.guid and IsTargetAliveRA(e) then
                        return e
                    end
                end
                -- Clone sedang respawn (baru mati / baru di-GET) -> tunggu,
                -- JANGAN jatuh ke musuh random lain selama lock masih aktif.
                return nil
            end
            ...
            for _,e in ipairs(GetEnemiesF()) do
                if IsTargetAliveRA(e) then
                    local skip = false
                    -- [RA EXCLUDE] Musuh yang sedang dipilih di dropdown "Pilih
                    -- Enemy" adalah jatah TARGET ATTACK -- RANDOM ATTACK harus
                    -- selalu menghindarinya, baik TARGET ATTACK sudah di-ON-kan
                    -- ataupun belum (cukup dipilih saja di dropdown). Mode By ID
                    -- exclude 1 guid spesifik; Mode By Name exclude SEMUA musuh
                    -- dengan nama yang sama (karena TA By Name menyerang semua
                    -- instance nama itu bergantian).
                    if TASelected.mode == "id" then
                        if TASelected.guid and e.guid == TASelected.guid then skip = true end
                    else
                        if TASelected.name and e.name == TASelected.name then skip = true end
                    end
        ...
        -- [EDIT] RE.Atk (PlayerClickAttackSkill) DIHAPUS. RE.Click (ClickEnemy)
        -- dikembalikan untuk fire tiap loop seperti semula.
    ...
    -- [SINGLE-NAME AUTO-STOP] Parameter ke-4 (singleMode): kalau true, artinya
    -- musuh dgn nama ini cuma ada 1 (x1) waktu dipilih dari dropdown. Kalau
    -- musuh itu mati dan tidak ada lagi yang tersisa (pool jadi kosong),
    -- TA langsung berhenti total & panggil onStop (mematikan toggle TA,
    -- dan RA juga kalau lagi nyala barengan) -- bukan masuk mode
    -- "WAITING ... respawn" seperti biasanya di mode By Name.
    local function StartTA_ByName(targetName, onStatus, onStop, singleMode)
        TA.running=true; TA.killed=0; TA.targetName=targetName; TA.cur=nil; TA.threads={}
        BlockEnemyHitAnim(true)
        BlockGlobalNuke(true)
        BlockSkillEffects(true, "TA")
        ...
        local tChar = task.spawn(function()
            ...
            while TA.running do
                ...
                if #pool == 0 then
                    if singleMode then
                        -- [SINGLE-NAME AUTO-STOP] Cuma ada 1 musuh nama ini dari awal
                        -- dan sekarang sudah tidak ada (mati) -> stop total, jangan nunggu respawn.
                        TA.cur = nil
                        if onStatus then onStatus(" ["..targetName.."] mati") end
                        TA.running = false
                        if onStop then onStop() end
    ...
    -- [FORWARD DECLARE] _taOnStop dipakai di Callback dropdown "Pilih Enemy"
    -- (auto-switch target saat TA sedang jalan) yang letaknya lebih atas dari
    -- definisi aslinya -> harus di-forward-declare di sini supaya scoping-nya
    -- benar-benar merujuk ke local yang sama (bukan diam-diam jadi global nil).
    -- _taSingleName: true kalau musuh target By Name yang lagi dipilih cuma
    -- ada 1 (x1) -> dipakai supaya TA/RA auto-OFF saat musuh itu mati.
    local _taOnStop
    local _taSingleName = false

    -- Mode dropdown: By ID / By Name (default: By Name)
    local _listMode = "name"
    FarmTab:Dropdown({
        Flag     = "farmTAMode",
        Title    = "Mode Select",
        ...
        Callback = function(val)
            ...
            -- [RA EXCLUDE] Ganti mode -> pilihan lama di dropdown "Pilih Enemy"
            -- sudah tidak relevan lagi, reset supaya RA tidak salah exclude.
            TASelected.mode = _listMode
            TASelected.guid = nil
            TASelected.name = nil
        end,
    })
    ...
    _enemyDropElement = FarmTab:Dropdown({
        ...
        Callback = function(val)
            ...
            -- [RA EXCLUDE] Sinkronkan musuh yang lagi dipilih di dropdown ini
            -- ke TASelected, supaya RANDOM ATTACK otomatis menghindarinya --
            -- walau TARGET ATTACK belum di-ON-kan sama sekali.
            if _listMode == "id" then
                local d = _enemyDropSelected and _enemyDataById[_enemyDropSelected]
                TASelected.guid = d and d.guid or nil
                TASelected.name = nil
            else
                local d = _enemyDropSelected and _enemyDataByName[_enemyDropSelected]
                TASelected.name = d and d.nm or nil
                TASelected.guid = nil
            end
            ...
            if _listMode == "id" then
                ...
                -- [SINGLE-NAME AUTO-STOP] Musuh cuma 1 (x1) -> auto-stop saat mati
                _taSingleName = (data.cnt == 1)
    ...
    FarmTab:Button({
        ...
        Callback = function()
            ...
            -- [RA EXCLUDE] List lama sudah dibuang, guid/name pilihan lama
            -- sudah tidak valid -> reset supaya RA tidak exclude musuh yang salah.
            TASelected.guid = nil
            TASelected.name = nil
            ...
            if _listMode == "id" then
                ...
                for _, nm in ipairs(names) do
                    ...
                    table.insert(_enemyDropValues, label)
                    -- [SINGLE-NAME AUTO-STOP] Simpan jumlah musuh dgn nama ini
                    -- (cnt) supaya nanti bisa dideteksi kalau cuma ada 1 (x1).
                    _enemyDataByName[label] = {nm=nm, cnt=nc[nm]}
                end
                if _taStatusPara then
    ...
    _taOnStop = function()
        ...
        -- DAN mode select-nya "By ID" (bukan "By Name"), ATAU mode "By Name"
        -- tapi musuhnya cuma ada 1 (x1) -> matikan RA juga secara total
        -- (fungsi/logika + visual toggle), bukan cuma TA.
        -- Tidak berlaku kalau RA sedang OFF, atau mode "By Name" dgn musuh > 1.
        if (_listMode == "id" or _taSingleName) and RA.running then
            StopRA()
            _raRunningState = false
    ...
    local function _spawnClone(srcData)
        ...
        -- [RA LOCK] Simpan guid clone ini supaya RANDOM ATTACK bisa mengunci
        -- target ke clone ini (lihat FastAttack1 di PickRandomEnemy).
        local _, cg = _getGuid(clone)
        FastAttack1.guid = cg
    ...
    local function _stopDupe()
        ...
        _dupeOn = false
        -- [RA LOCK] Fast Attack 1 Enemy dimatikan -> lepas kunci target RA,
        -- balik ke pencarian musuh random normal (exclude TA dropdown saja).
        FastAttack1.active = false
        FastAttack1.guid   = nil
        _dupeStatus("Idle")
    end
        ...
        _dupeConn = RunService.Heartbeat:Connect(function(dt)
            ...
            if not cloneAlive then
                ...
                if newData then
                    ...
                    -- [RA LOCK] Tidak ada musuh tersisa untuk di-clone -> lepas
                    -- kunci sementara supaya RA tidak diam menunggu selamanya;
                    -- lock otomatis terpasang lagi begitu clone baru berhasil dibuat.
                    FastAttack1.guid = nil
    ...
    FarmTab:Button({
        ...
        Callback = function()
            ...
            _dupeOn = true
            -- [RA LOCK] Aktifkan kunci target RA ke clone Fast Attack 1 Enemy.
            FastAttack1.active = true
            FastAttack1.guid   = nil
            BlockEnemyHitAnim(true)
            BlockGlobalNuke(true)
            _startDupe()
    ...
    local function AttackLoop_Mass(onStatus, noRotation)
        ...
        while MA.running do
            ...
            do
                ...
                if ok and type(wm) == "number" then
                    if wm < 50001 or wm > 50021 then _MA_StopAllSpam(); _StopEnemyPullWorker(); return "interrupted" end
                end
            end
        ...
        function _MA_GetCurrentMapNum()
            local ok, result = pcall(function()
                ...
                if type(wm) == "number" then
                    if wm >= 50001 and wm <= 50021 then return wm - 50000 end
                    if wm >= 1 and wm <= 21 then return wm end
                end
                return nil
            end)
                ...
                if type(val) == "table" then
                    for k, info in pairs(val) do
                        ...
                        if type(info) == "table" and info.raidId and info.mapId then
                            ...
                            if mapId < 50001 or mapId > 50021 then break end
